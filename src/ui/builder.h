...
namespace gyverhub {
    ...
    enum BuildType {
        GH_BUILD_NONE,
        GH_BUILD_ACTION,  // set command or set topic
        GH_BUILD_COUNT,  // before ui
        GH_BUILD_READ,  // read topic
        GH_BUILD_UI,  // ui
    };
    ...
    private:
        ...
        Json* sptr = nullptr;
        GHclient client {};
        BuildType buildType = GH_BUILD_NONE;
    ...
    public:
        ...
        static bool buildSet(BuildCallback cb, const char* name, const char* value, GHclient client){
            Builder b{GH_BUILD_ACTION, name, value};
            b.client = client;
            cb(&b);
        ...
        static bool buildRead(BuildCallback cb, gyverhub::Json *answ, const char* name) {
            Builder b{GH_BUILD_READ, name};
            b.sptr = answ;
            cb(&b);
            return b.buildType == GH_BUILD_NONE;
        }

        static size_t buildCount(BuildCallback cb, GHclient client) {
            Builder b{GH_BUILD_COUNT};
            b.client = client;
            gyverhub::Json count;
            b.sptr = &count;
            cb(&b);
    ...
    private:
        ...
        bool _checkName() {
            if (sptr && buildType == GH_BUILD_READ && autoNameEq()) {
                buildType = GH_BUILD_NONE;
                return true;
            }
            return false;
        }
        ...
        bool _parse(void *var, GHdata_t dtype) {
            if (sptr && buildType == GH_BUILD_ACTION && autoNameEq()) {
                buildType = GH_BUILD_NONE;
                parse(var, dtype);
                return true;
            }
        ...
        bool _isUI() {
            return sptr && (buildType == GH_BUILD_UI || buildType == GH_BUILD_COUNT);
        }
    ...
    public:
        ...
        // ========================== BUTTON ==========================
        bool Button(gyverhub::Button* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT, int size = 20) {
        ...
        bool ButtonIcon(gyverhub::Button* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT, int size = 50) {
        ...
        // ========================== LABEL ==========================
        void Label(CSREF value = "", FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT, int size = 40) {
        ...
        // ========================== DISPLAY ==========================
        void Display(FSTR value = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT, int rows = 2, int size = 40) {
        ...
        // ========================== INPUT ==========================
        bool Input(void* var = nullptr, GHdata_t type = GH_NULL, FSTR label = nullptr, int maxv = 0, FSTR regex = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // ========================== PASS ==========================
        bool Pass(void* var = nullptr, GHdata_t type = GH_NULL, FSTR label = nullptr, int maxv = 0, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool _input(bool fstr, FSTR tag, void* var, GHdata_t type, VSPTR label, int maxv, VSPTR regex, gyverhub::Color color) {
            _nameAuto();
            if (_isUI()) {
                _begin(tag);
                _name();
        ...
        // ========================== SLIDER ==========================
        bool Slider(void* var = nullptr, GHdata_t type = GH_NULL, FSTR label = nullptr, float minv = 0, float maxv = 100, float step = 1, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // ========================== SPINNER ==========================
        bool Spinner(void* var = nullptr, GHdata_t type = GH_NULL, FSTR label = nullptr, float minv = 0, float maxv = 100, float step = 1, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool _spinner(bool fstr, FSTR tag, void* var, GHdata_t type, VSPTR label, float minv, float maxv, float step, gyverhub::Color color) {
            _nameAuto();
            if (_isUI()) {
                _begin(tag);
                _name();
        ...
        // ========================== GAUGE ===========================
        void Gauge(float value = 0.f, FSTR text = nullptr, FSTR label = nullptr, float minv = 0.f, float maxv = 100.f, float step = 1.f, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
            _gauge(true, value, text, label, minv, maxv, step, color);
        }
        void Gauge(float value, CSREF text, CSREF label = "", float minv = 0.f, float maxv = 100.f, float step = 1.f, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool Switch(bool* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool SwitchIcon(bool* var = nullptr, FSTR label = nullptr, FSTR text = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool SwitchText(bool* var = nullptr, FSTR label = nullptr, FSTR text = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // ========================== DATETIME ==========================
        bool Date(void* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool Time(void* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        bool DateTime(void* var = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // ========================== FLAGS ==========================
        bool Flags(GHflags<64>* var = nullptr, FSTR text = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
            return _flags(true, var, text, label, color);
        }
        bool Flags(GHflags<64>* var, CSREF text, CSREF label = "", gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // =========================== JOY ===========================
        bool Joystick(gyverhub::Point* pos = nullptr, bool autoc = 1, bool exp = 0, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // =========================== DPAD ===========================
        bool Dpad(gyverhub::Point* pos = nullptr, FSTR label = nullptr, gyverhub::Color color = gyverhub::Colors::GH_DEFAULT) {
        ...
        // ========================= PROMPT ========================
        bool Prompt(void* value = nullptr, GHdata_t type = GH_NULL, FSTR label = nullptr) {
        ...
        bool _prompt(bool fstr, void* value, GHdata_t type, VSPTR label) {
            _nameAuto();
            if (_isUI()) {
                _begin(F("prompt"));
                _name();
